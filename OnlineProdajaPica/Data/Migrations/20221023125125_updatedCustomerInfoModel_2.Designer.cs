...
namespace OnlineProdajaPica.Data.Migrations
{
    ...
    [Migration("20221023125125_updatedCustomerInfoModel_2")]
    partial class updatedCustomerInfoModel_2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineProdajaPica.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineProdajaPica.Models.CustomerInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineProdajaPica.Models.Order", b =>
                {
                    ...
                    b.Property<string>("Kolicine")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Proizvodi")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("OnlineProdajaPica.Models.Category", b =>
                {
                    b.HasOne("OnlineProdajaPica.ViewModels.ProductViewModel", null)
                        .WithMany("Categories")
            ...
            modelBuilder.Entity("OnlineProdajaPica.Models.Product", b =>
                {
                    b.HasOne("OnlineProdajaPica.Models.Category", "Category")
                        .WithMany()
